    ...
    for i in range(starty + 1, phi.shape[0] - 1, stridey):
        for j in range(startx + 1, phi.shape[1]- 1, stridex):
                ...
                if j < M - 1:
                    ...
                    phi_out[i][j] = phi_out[i][j-1]
                    c_out[i][j] = c_0
                    c_s_out[i][j] = c_out[i][j-1] * kini / (kini * phi[i][j-1] - phi_out[i][j-1] + 1)  # c_s[i, M-1]
                    c_l_out[i][j] = c_out[i][j-1] / (kini * phi[i][j-1] - phi_out[i][j-1] + 1)  # c_l[i, M-1]
                    theta_out[i][j] = theta_out[i][j-1]


class pcr_mf(Simulation):
    ...
    def simulation_loop(self):
        ...
        if (self.time_step_counter-1)%5                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          == 0:
            self.retrieve_fields_from_GPU()
            output_folder = 'mf_final'  ##
            os.makedirs(output_folder, exist_ok=True)
            phi = self.fields[0].data
            df = pd.DataFrame(phi)
            filename = os.path.join(output_folder, f'phi_step{self.time_step_counter}.csv')
            ...
            filename = os.path.join(output_folder, f'tarr_step{self.time_step_counter}.csv')
            df.to_csv(filename, index=False, header=False)

            theta = self.fields[4].data
            df = pd.DataFrame(theta)
            filename = os.path.join(output_folder, f'theta_step{self.time_step_counter}.csv')
            df.to_csv(filename, index=False, header=False)
